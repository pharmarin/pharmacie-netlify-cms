...
import { ArticleByIdQuery, File } from "../../../graphql-types";

export const ArticleSingle: React.FC<{
  categories?: string[];
  content?: string;
...
const ArticleSingleContainer: React.FC<PageProps<ArticleByIdQuery>> = ({
  data,
}) => {
...
export default ArticleSingleContainer;
